...
<head>
  ...
  <title>ADDCAR-ALIFAH MEILIANA-1202204114</title>
...
<body>
  ...
  <section id='form'>
    <div class="container">
      ...
      <p class="tambahp">Tambah mobil baru sekarang juga Ke List Show Room</p>
      <form action="../config/insert.php" method="POST" enctype="multipart/form-data">
        ...
        <button type="submit" class="btn btn-primary" style="margin-top: 40px;">Add Car</button>
      </form>
    </div>
  </section>
  <!-- Form End -->
