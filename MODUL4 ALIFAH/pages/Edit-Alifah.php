...
$sql = "SELECT * FROM showroom_alifah_table WHERE id_mobil = $id";
...
<head>
  ...
  <title>EDIT - ALIFAH - 1202204114</title>
    ...
    <div class="container py-2">
      <?php if (isset($_SESSION["login"])) : ?>
        <div class="navbar-nav">
          ...
          <a class="nav-link" href="pages/ListCar-Alifah.php">MyCar</a>
        </div>
        <div class="d-flex">
          <a href="pages/Add-Nama.php" class="btn btn-light text-<?= isset($_COOKIE["warna_navbar"])  ? $_COOKIE["warna_navbar"] : "success"; ?>" role="button">Add Car</a>
          <div class="dropdown ms-4">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item text-<?= isset($_COOKIE["warna_navbar"])  ? $_COOKIE["warna_navbar"] : "success"; ?>" href="pages/Profile-Nama.php">Profile</a></li>
